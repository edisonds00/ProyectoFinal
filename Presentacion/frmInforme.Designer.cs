namespace ProyectoPOE.View
{
    partial class frmInforme
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblCedulaMecanico = new Label();
            lblNombreMecanico = new Label();
            label8 = new Label();
            label9 = new Label();
            label10 = new Label();
            label11 = new Label();
            ...
            listaRepuesto = new ListView();
            Nombre = new ColumnHeader();
            Precio = new ColumnHeader();
            lblRepuesto = new Label();
            groupBox6 = new GroupBox();
            listaServicio = new ListView();
            columnHeader1 = new ColumnHeader();
            columnHeader2 = new ColumnHeader();
            groupBox7 = new GroupBox();
            lblSubtotal = new Label();
            label21 = new Label();
            lblCostoMantenimiento = new Label();
            label16 = new Label();
            lblTotal = new Label();
            lblIva = new Label();
            lblCostoServicio = new Label();
            lblCostoRepuesto = new Label();
            label26 = new Label();
            label25 = new Label();
            label23 = new Label();
            label24 = new Label();
            ...
            groupBox1.Controls.Add(lblCedulaCliente);
            ...
            // groupBox2
            // 
            groupBox2.Controls.Add(lblJornada);
            groupBox2.Controls.Add(lblEspecialidad);
            groupBox2.Controls.Add(lblCedulaMecanico);
            groupBox2.Controls.Add(lblNombreMecanico);
            ...
            // groupBox3
            // 
            groupBox3.Controls.Add(lblAnio);
            ...
            // groupBox4
            // 
            groupBox4.Controls.Add(lblTipoMantenimiento);
            groupBox4.Controls.Add(lblTrabajo);
            groupBox4.Controls.Add(lblDiagnostico);
            ...
            // groupBox5
            // 
            groupBox5.Controls.Add(listaRepuesto);
            ...
            // groupBox7
            // 
            groupBox7.Controls.Add(lblSubtotal);
            groupBox7.Controls.Add(label21);
            groupBox7.Controls.Add(lblCostoMantenimiento);
            groupBox7.Controls.Add(label16);
            groupBox7.Controls.Add(lblTotal);
            groupBox7.Controls.Add(lblIva);
            groupBox7.Controls.Add(lblCostoServicio);
            groupBox7.Controls.Add(lblCostoRepuesto);
        ...
        private Label lblCostoRepuesto;
        private Label lblJornada;
        private Label lblEspecialidad;
        private Label lblCedulaMecanico;
        private Label lblNombreMecanico;
        ...
        private Label lblCostoMantenimiento;
        private Label label16;
        private ListView listaRepuesto;
        private ColumnHeader Nombre;
        private ColumnHeader Precio;
        private ListView listaServicio;
